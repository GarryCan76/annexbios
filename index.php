    ...
    <nav class="navbar">
        ...
        <div class="vestigingen">
            ...
            <div class="vestiging" id="vestiging1">
                ...
                <h2 class="naam_vestiging">HELLEVOETSLUIS</h2>
                <p class="locatie_vestiging">Rijksstraatweg 42, 3223 KA</p>
                <div class="button_naarvestiging" style="background-color: #9E2629;"><span>BEZOEK WEBSITE</span></p></div>
            </div>
            <div class="vestiging" id="vestiging1">
                <img class="foto_vestiging" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpIz3GryzUBx3wsZlI5bGqv2x5VW6xfuuhIPM75VmU4Q&s" alt="foto van de film">
                <h2 class="naam_vestiging">HELLEVOETSLUIS</h2>
                <p class="locatie_vestiging">Rijksstraatweg 42, 3223 KA</p>
                <div class="button_naarvestiging" style="background-color: #8B9E51;"><span>BEZOEK WEBSITE</span></p></div>
            </div>
            <div class="vestiging" id="vestiging1">
                <img class="foto_vestiging" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpIz3GryzUBx3wsZlI5bGqv2x5VW6xfuuhIPM75VmU4Q&s" alt="foto van de film">
                <h2 class="naam_vestiging">HELLEVOETSLUIS</h2>
                <p class="locatie_vestiging">Rijksstraatweg 42, 3223 KA</p>
                <div class="button_naarvestiging" style="background-color: #6E4F7D;"><span>BEZOEK WEBSITE</span></p></div>
            </div>
            <div class="vestiging" id="vestiging1">
                <img class="foto_vestiging" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpIz3GryzUBx3wsZlI5bGqv2x5VW6xfuuhIPM75VmU4Q&s" alt="foto van de film">
                <h2 class="naam_vestiging">HELLEVOETSLUIS</h2>
                <p class="locatie_vestiging">Rijksstraatweg 42, 3223 KA</p>
                <div class="button_naarvestiging" style="background-color: #4596BA;"><span>BEZOEK WEBSITE</span></p></div>
            </div>
            <div class="vestiging">
